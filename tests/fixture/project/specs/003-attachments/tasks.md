...
## Phase 1: User Story 1 - Attach a file to a task (Priority: P1)

- [X] T001 [US1] Add the `Attachment` model in `src/api/models.py`
- [X] T002 [P] [US1] Add the upload route in `src/api/attachments.py`
